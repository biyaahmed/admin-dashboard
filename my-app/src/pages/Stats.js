...
//             </select>
//             <button className="bg-white px-6 py-2 rounded-xl font-semibold" style={{color:"#2e2163"}}>
//               <i className="fas fa-download mr-2" style={{color:"#2e2163"}}></i>
//               Export
//             </button>
//           </div>
//         </div>
...
//         {/* Revenue Chart */}
//         <div className="bg-white rounded-2xl shadow-sm  p-6" style={{border:"1px solid #2e2163"}}>
...
//         {/* Top Products */}
//         <div className=" rounded-2xl shadow-sm  overflow-hidden" style={{border:"1px solid #2e2163",}}>
//           <div className="px-6 py-4 border-b border-orange-100 " style={{backgroundColor:"#2e2163"}}>
//             <h2 className="text-xl font-bold text-gray-900" style={{color:"#ffffff"}}>Top Products</h2>
//             <p className="text-gray-600 text-sm mt-1" style={{color:"#ffffff"}}>Best selling bakery items</p>
//           </div>
